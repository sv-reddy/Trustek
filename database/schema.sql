-- ================================================
-- TrusTek Fusion - Complete Database Schema
-- ================================================
-- This file contains the complete database schema including:
-- 1. Tables (user_profiles, session_keys, transaction_log, market_data, user_sessions)
...
-- ================================================
-- CLEANUP: Drop existing objects (run first if recreating)
-- ================================================
...
-- Function to expire session keys
...
BEGIN
    RAISE NOTICE '========================================';
    RAISE NOTICE 'TrusTek Fusion Database Setup Complete!';
    RAISE NOTICE '========================================';
    RAISE NOTICE 'Tables created: 5';
    RAISE NOTICE '  - user_profiles';
    RAISE NOTICE '  - session_keys';
    RAISE NOTICE '  - transaction_log';
    RAISE NOTICE '  - market_data';
    RAISE NOTICE '  - user_sessions';
    RAISE NOTICE '';
    RAISE NOTICE 'Views created: 3';
    RAISE NOTICE '  - active_session_keys_count';
    RAISE NOTICE '  - recent_transactions';
    RAISE NOTICE '  - user_portfolio_summary';
    RAISE NOTICE '';
    RAISE NOTICE 'Functions created: 5';
    RAISE NOTICE '  - update_updated_at_column()';
    RAISE NOTICE '  - expire_session_keys()';
    RAISE NOTICE '  - cleanup_inactive_sessions()';
    RAISE NOTICE '  - logout_user()';
    RAISE NOTICE '';
